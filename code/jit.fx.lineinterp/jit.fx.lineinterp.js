...
slab.file = "jit.fx.lineinterp.threshold.jxs";
slab.inputs = 1;
slab.type = "float32";
slab.rectangle = 1;
slab.automatic = 0;
...
slab_transitions.file = "jit.fx.lineinterp.find.transitions.jxs";
...
shader_startend.file = "jit.fx.lineinterp.find.start.end.jxs";
...
slab_combine.file = "jit.fx.lineinterp.combine.start.stop.jxs";
...
shader_makeline.file = "jit.fx.lineinterp.make.line.jxs";
...
slab_composite.file = "jit.fx.lineinterp.composite.jxs";
...
function setdimmode(v){ 
	dimmode = Math.max(0, Math.min(2, v));
